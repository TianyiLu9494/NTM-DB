...
const columnDefs_vf = [
  {
    ...
    cellRenderer: function (params) {
      return `<i><a href="/ntmdb/gene/virulence_gene/vfg_id=${params.data.vfg_id}"> ${params.value} </a></i>`
    }
  },
  {
...
downloadButton.addEventListener('click', function () {
  gridOptions_vf.api.exportDataAsCsv(); // 导出 CSV 文件
});
